...
// personal-vWlSbmkZVN [vsLsbMMZJV]
(function() {
  $(function() {
    $(".personal-vWlSbmkZVN").each(function() {
      const $block = $(this);
      // Header Scroll
